  ...
  return (
    <nav className={`sidebar${isOpen ? ' abierto' : ''}`} id="sidebar" aria-label="Menú principal">
      ...
      <ul className="menu-principal">
        ...
        <li><NavLink to="/admin/perfil" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-user-cog"></i></div> Mi Perfil</NavLink></li>
      </ul>
    </nav>
  )
}
