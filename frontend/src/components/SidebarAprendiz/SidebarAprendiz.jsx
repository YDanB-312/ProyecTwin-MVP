  ...
  return (
    <nav className={`sidebar${isOpen ? ' abierto' : ''}`} id="sidebar">
      ...
      <ul className="menu-principal">
        ...
        <li><NavLink to="/aprendiz/detalle-ficha" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-users"></i></div> Mi Ficha</NavLink></li>
