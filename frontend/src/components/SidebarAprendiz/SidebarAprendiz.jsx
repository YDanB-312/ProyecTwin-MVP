  ...
  return (
    <nav className={`sidebar${isOpen ? ' abierto' : ''}`} id="sidebar" aria-label="Menú principal">
      ...
      <ul className="menu-principal">
        ...
        <li><NavLink to="/aprendiz/mis-proyectos" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-folder-open"></i></div> Mis proyectos</NavLink></li>
        <li><NavLink to="/aprendiz/nuevo-proyecto" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-plus-circle"></i></div> Nuevo proyecto</NavLink></li>
        <li><NavLink to="/aprendiz/detalle-ficha/ADSO-2568" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-users"></i></div> Mi Ficha</NavLink></li>
        <li><NavLink to="/aprendiz/unirse-ficha" className={({ isActive }) => 'enlace-nav' + (isActive ? ' activo' : '')} onClick={onClose}><div className="icono-nav"><i className="fas fa-user-plus"></i></div> Unirse a Ficha</NavLink></li>
